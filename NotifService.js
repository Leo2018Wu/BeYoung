...
export default class NotifService {
  ...
  localNotif(soundName) {
    ...
    PushNotification.localNotification({
      ...
      // channelId: soundName ? 'ound-channel-id' : 'default-channel-id',
      channelId: '1',
      ticker: 'My Notification Ticker', // (optional)
      autoCancel: true, // (optional) default: true
      largeIcon: 'ic_launcher', // (optional) default: "ic_launcher"
      smallIcon: 'ic_notification', // (optional) default: "ic_notification" with fallback for "ic_launcher"
      bigText: soundName.body, // (optional) default: "message" prop
      ...
      message: soundName.body, // (required)
      userInfo: soundName.extras, // (optional) default: {} (using null throws a JSON value '<null>' error)
