...
var Login = function (_a) {
    ...
    var item = props.item;
    var _b = react_1.useState([{ id: 0 }, { id: 1 }, { id: 2 }]), imgList = _b[0], setImgList = _b[1];
    ...
    return (react_1["default"].createElement(react_native_1.Pressable, { onPress: function () { return props.navigation.navigate('DynamicItemDetail'); }, style: {
            flexDirection: 'row',
        ...
        react_1["default"].createElement(native_base_1.View, { style: styles.itemContain },
            ...
            react_1["default"].createElement(native_base_1.View, { style: {
                ...
                imgList.map(function (item, index) {
                    return (react_1["default"].createElement(native_base_1.Image, { source: require('../../assets/IMG_2728.png'), style: {
                            width: 85,
                            height: 85,
                            borderRadius: 10
                        } }));
            ...
            react_1["default"].createElement(native_base_1.View, { style: styles.optContain },
                ...
                react_1["default"].createElement(native_base_1.View, { style: styles.optView },
                    react_1["default"].createElement(native_base_1.Image, { source: require('../../assets/home_linke.png'), style: {
                            width: 18,
                            height: 18,
                            marginRight: 3
                        } }),
                ...
                react_1["default"].createElement(native_base_1.View, { style: styles.optView },
                    react_1["default"].createElement(native_base_1.Image, { source: require('../../assets/home_gift.png'), style: {
                            width: 18,
                            height: 18,
                            marginRight: 3
                        } }),
