...
var Index = function (_a) {
    ...
    var edit = function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!(params.keyName == 'nickName')) return [3 /*break*/, 2];
                    return [4 /*yield*/, run({ nickName: inputValue })];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 2:
                    if (!(params.keyName == 'name')) return [3 /*break*/, 4];
                    return [4 /*yield*/, run({ name: inputValue })];
                case 3:
                    _a.sent();
                    _a.label = 4;
                case 4:
    ...
    return (react_1["default"].createElement(native_base_1.Box, { flex: 1 },
        ...
        editType === '昵称' && (react_1["default"].createElement(native_base_1.HStack, { px: 4, alignItems: 'center', h: 16 },
            react_1["default"].createElement(native_base_1.Text, { fontWeight: 'bold', fontSize: 'md' }, "\u7F16\u8F91\u6635\u79F0\uFF1A"),
            react_1["default"].createElement(native_base_1.Input, { clearButtonMode: "while-editing", onChangeText: function (e) { return setValue(e); }, flex: 1, fontSize: 'md', value: inputValue, placeholder: "\u8BF7\u8F93\u5165\u6635\u79F0" }))),
        editType === '姓名' && (react_1["default"].createElement(native_base_1.HStack, { px: 4, alignItems: 'center', h: 16 },
            react_1["default"].createElement(native_base_1.Text, { fontWeight: 'bold', fontSize: 'md' }, "\u7F16\u8F91\u59D3\u540D\uFF1A"),
            react_1["default"].createElement(native_base_1.Input, { clearButtonMode: "while-editing", onChangeText: function (e) { return setValue(e); }, flex: 1, fontSize: 'md', value: inputValue, placeholder: "\u8BF7\u8F93\u5165\u59D3\u540D" })))));
};
