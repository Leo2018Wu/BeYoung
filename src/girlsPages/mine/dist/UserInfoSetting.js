...
var Setting = function (_a) {
    ...
    var editUser = function (type, value, keyName) {
    ...
    return (react_1["default"].createElement(native_base_1.NativeBaseProvider, null,
        react_1["default"].createElement(native_base_1.ScrollView, { style: styles.userInfoContain },
            ...
            react_1["default"].createElement(native_base_1.Pressable, { onPress: function () { return editUser('昵称', result === null || result === void 0 ? void 0 : result.nickName, 'nickName'); }, style: styles.itemView },
            ...
            react_1["default"].createElement(native_base_1.Pressable, { onPress: function () { return editUser('姓名', result === null || result === void 0 ? void 0 : result.name, 'name'); }, style: styles.itemView },
            ...
            react_1["default"].createElement(native_base_1.View, { style: styles.itemView },
                ...
                react_1["default"].createElement(native_base_1.View, { style: {
                    ...
                    react_1["default"].createElement(native_base_1.Text, { style: { color: '#919191', marginRight: 4 } }, "\u6635\u79F0"),
                    react_1["default"].createElement(AntDesign_1["default"], { name: "right", size: 16, color: "#919191" }))),
            react_1["default"].createElement(native_base_1.View, { style: styles.itemView },
                ...
                react_1["default"].createElement(native_base_1.View, { style: {
                    ...
                    react_1["default"].createElement(native_base_1.Text, { style: { color: '#919191', marginRight: 4 } }, "13356562731"),
                    react_1["default"].createElement(AntDesign_1["default"], { name: "right", size: 16, color: "#919191" }))),
            react_1["default"].createElement(native_base_1.View, { style: styles.itemView },
            ...
            react_1["default"].createElement(native_base_1.View, { style: styles.itemView },
                ...
                react_1["default"].createElement(native_base_1.View, { style: {
                    ...
                    react_1["default"].createElement(native_base_1.Text, { style: { color: '#919191', marginRight: 4 } }, "1234567890"),
                    react_1["default"].createElement(AntDesign_1["default"], { name: "right", size: 16, color: "#919191" }))),
            react_1["default"].createElement(native_base_1.View, { style: styles.itemView },
