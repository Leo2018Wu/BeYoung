...
var DailyTab_1 = require("./DailyTab");
...
var Index = function (_a) {
    ...
    return (react_1["default"].createElement(native_base_1.Box, { flex: 1 },
        react_1["default"].createElement(native_base_1.ScrollView, { contentContainerStyle: { flex: 1 }, py: 4, bg: "white" },
            react_1["default"].createElement(native_base_1.Box, { px: 5, pb: 4 },
                ...
                react_1["default"].createElement(native_base_1.View, { pt: 4 },
                    ...
                    react_1["default"].createElement(native_base_1.Text, { fontSize: 'md', color: 'fontColors._72' }, item.content))),
            react_1["default"].createElement(native_base_1.Divider, { h: 2.5, bg: "bg.f5" }),
            react_1["default"].createElement(native_base_1.Box, { flex: 1 },
                react_1["default"].createElement(DailyTab_1["default"], null)))));
};
